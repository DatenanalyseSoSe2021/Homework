...
###### Interpretation: 
   ...
   - Overall, the model has an R-squared from `r summary(lm.fit)$r.sq`. This tells us that 39,4% of the variability in whether the person survived can be explained by their class and sex. 
